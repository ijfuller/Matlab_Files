...
if Cal_View_Factors==1
    ...
    %%%Call Monte Carlo Function - Panel 1,2 Aper to floor 
    if cover_n==1 && cover_m==1
        [F_Panel_1_Floor,F_Panel_2_Floor,F_Aper_Floor,F_Aper_Roof,F_Top_Lip_Floor,F_Top_Lip_Roof,F_Bottom_Lip_Floor,F_Bottom_Lip_Roof] = Monte_Carlo_Panel_Floor_Pent_Function_v2(N_rays,El_Nod_Conn_Panel, El_Nod_Conn_Cover, Global_Nodal_Coord_Panel, Global_Nodal_Coor_Cover, Receiver_Width, Receiver_Height,Top_Lip, Bottom_Lip);
    else
    ...
    %%%Call Monte Carlo for Top/Bottom Lip to Floor/Roof%%%
    if Top_Lip > 0 && cover_n ==1 && cover_m==1
        [F_Bottom_Lip_Floor,F_Top_Lip_Floor,F_Bottom_Lip_Roof,F_Top_Lip_Roof] = MC_Lip_Floor_Roof_Pent_Function(Receiver_Height,Receiver_Width,Top_Lip,Bottom_Lip,N_rays,El_Nod_Conn_Panel,El_Nod_Conn_Cover,Global_Nodal_Coord_Panel,Global_Nodal_Coor_Cover)
    elseif Top_Lip > 0 && cover_n*cover_m > 1
        [F_Bottom_Lip_Floor,F_Top_Lip_Floor,F_Bottom_Lip_Roof,F_Top_Lip_Roof] = MC_Lip_Floor_Roof_Function(Receiver_Height,Receiver_Width,Top_Lip,Bottom_Lip,N_rays,El_Nod_Conn_Panel,El_Nod_Conn_Cover,Global_Nodal_Coord_Panel,Global_Nodal_Coor_Cover,cover_n,cover_m)
    end
    %%%Build View Factor Matrix
    [VF_Matrix] = View_Factor_Matrix_Temp_Function_v3(N_el_domain,F_Panel_1_to_Panel,F_Panel_1_Floor,F_Panel_2_Floor,F_Roof_Floor,F_Aper_Floor,F_Aper_Roof,A_Roof,A_Panel,A_Aperature,A_Top_Lip,A_Bottom_Lip,F_Top_Lip_Floor,F_Bottom_Lip_Floor,F_Top_Lip_Roof,F_Bottom_Lip_Roof,Top_Lip,Bottom_Lip,Save_View_Factor_File,Save_View_Factor_Filename,panel_n,panel_m,cover_n,cover_m);
else
