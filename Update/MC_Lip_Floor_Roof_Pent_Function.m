function [F_Bottom_Lip_Floor,F_Top_Lip_Floor,F_Bottom_Lip_Roof,F_Top_Lip_Roof] = MC_Lip_Floor_Roof_Function(Receiver_Height,Receiver_Width,Top_Lip,Bottom_Lip,N_rays,El_Nod_Conn_Panel,El_Nod_Conn_Cover,Global_Nodal_Coord_Panel,Global_Nodal_Coor_Cover)
...
%                 offset_rect_y=Global_Nodal_Coord_Panel(El_Nod_Conn_Panel(ii,1),2); %Vertical offset
    ...
    if ii==1
        F_Top_Lip_Floor=F(1,jj); 
    end
    if ii==2
        F_Top_Lip_Roof=F(2,jj); 
    end
    if ii==3
        F_Bottom_Lip_Floor=F(3,jj); 
    end
    if ii==4
        F_Bottom_Lip_Roof=F(4,jj); 
    end   
end
    display('-----------------------------------------------')
