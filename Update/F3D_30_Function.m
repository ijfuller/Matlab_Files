function [F_Panel_1_to_Panel] = F3D_30_Function_v3(panel_m,panel_n,Receiver_Width,Receiver_Height,El_Nod_Conn_Panel,Global_Nodal_Coord_Panel,Top_Lip,Bottom_Lip)
%%%%%%%%%%%%%%%%%%%%%%%%%%%F3D-30%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    panel_width=(Receiver_Width/2)*cosd(interior_angle/2)*2; %Width of each panel
        ...
        display('-----------------------------------------------')
        display('F3D-30 Function Complete')
        display('-----------------------------------------------')
end
