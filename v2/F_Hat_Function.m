function [F_hat_sol,F_hat_therm,epsilon_sol,epsilon_therm,rho_sol,rho_therm] = F_Hat_Function(N_el_domain,VF_Matrix, epsilon_sol,epsilon_therm)
    KD=eye(N_el_domain);
    ...
    if N_el_domain == 9
        epsilon_sol(9)=epsilon_sol(5);
        epsilon_therm(9)=epsilon_therm(5);
    end
