...
plot_panel=4; %Which panel to plot. Outer panel (1), inner panel (2), aperature-floor (3), top lip-floor (5), top lip-roof (6), bottom lip-floor (7), bottom lip-roof (8)

F_Bottom_Lip_Floor=0;
F_Top_Lip_Floor=0;
F_Bottom_Lip_Roof=0; 
F_Top_Lip_Roof=0;
F_Aper_Roof=0;
...
if plot_MC_Ray==1;
    ...
    for panel=1:set %Think this is panel 1, panel 2, aperature, top lip-floor, top lip-roof
