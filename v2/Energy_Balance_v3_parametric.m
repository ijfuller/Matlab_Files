...
xlswrite('PS10_10MW_No_Lip_Solar',Q_sol_loss_perc)
...
title('Solar Radiation Loss','FontSize', 24)
xlabel('Solar Active Absorbtion','FontSize', 16) 
ylabel('Loss %','FontSize', 16) 
legend({'a_p_a_s_s_i_v_e = 0','a_p_a_s_s_i_v_e = 0.2','a_p_a_s_s_i_v_e = 0.4','a_p_a_s_s_i_v_e = 0.6','a_p_a_s_s_i_v_e = 0.8','a_p_a_s_s_i_v_e = 1'},'Location','southwest','FontSize', 16)
