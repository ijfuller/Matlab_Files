...
A_Roof=(1+sqrt(2))*panel_width^2;
A_Panel=panel_width*Receiver_Height;
A_Top_Lip=Top_Lip*Receiver_Width;
A_Bottom_Lip=Bottom_Lip*Receiver_Width;
A_Aperature=(Receiver_Height*Receiver_Width)-A_Top_Lip-A_Bottom_Lip;
