function [F_Panel] = F3D_30_Function(panel_m,panel_n,Receiver_Width,El_Nod_Conn_Panel,Global_Nodal_Coord_Panel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%F3D-30%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    theta_set=[135,90,45];
    panel_int_offset=[0,cosd(theta_set(2)/2)*panel_width,(Receiver_Width/sind(45))*sind(67.5)-panel_width];
    for kk=1:3
        theta=theta_set(kk);
        for ii=1:N_el
            for jj=1:N_el
