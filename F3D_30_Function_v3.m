function [F_Panel_1_to_Panel, F_Panel_2_to_Panel] = F3D_30_Function_v3(panel_m,panel_n,Receiver_Width,Receiver_Height,El_Nod_Conn_Panel,Global_Nodal_Coord_Panel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%F3D-30%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    panel_width=(Receiver_Width/2)*cosd(interior_angle/2)*2; %Width of each panel
        ...
        theta_set=[135,90,45, 67.5]; %Angles to panel 2, 3, 4, panel 1 -receiver aperature, panel 2 -receiver aperature 
        ...
        F_Panel_2_to_Panel=[F_Panel(:,:,1), F_Panel(:,:,1), F_Panel(:,:,2), 0];
end
